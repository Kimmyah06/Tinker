...
<body>
    <nav class="navbar navbar-dark navbar-expand-md fixed-top bg-dark">
        <div class="container-fluid"><img src="<?php echo e(asset('img/Tinker.png')); ?>" width="5" height="10" style="width: 40px;height: 40px;padding-left: 0px;margin-left: 15px;" />
            ...
            </div><a class="btn btn-secondary" role="button" style="margin-right: 0px;padding-right: 11px;" href="<?php echo e(route('logout')); ?>">Log Out</a>
        </div>
            ...
            <tbody>
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td style="height: 55px;"><?php echo e($product->quantity); ?></td>
                        <td style="padding: 8px;padding-left: 0px;margin: 0px;margin-left: 1px;width: 190.344px;"><button class="btn btn-info editbtn" type="button" style="margin-right: 20px;">Edit</button><button class="btn btn-danger delete" type="button" data-bs-target="#modal-3" data-bs-toggle="modal" data-id=<?php echo e($product->product_number); ?>>Delete</button></td>
                    </tr>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="modal-3">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('product.delete')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Kimberly_PC\Documents\GitHub\Serverus\resources\views/dashboard.blade.php ENDPATH**/ ?>